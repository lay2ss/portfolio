          ...
          <img src="/assets/logo.png" alt="logo" loading="lazy" />
            ...
            <div className={`top-2 right-18 md:right-6 absolute flex flex-wrap btn-lang figtree-400 text-[14px] rounded-lg max-w-[54px] h-10 ${turn ? 'h-fit' : ''}`} onClick={turnArrow}>
              <div className="flex items-center gap-2">
                ...
                <img src="/assets/arrow.png" alt="arrow icon" className={`w-min h-min arrow ${turn ? 'turn' : ''}`} loading="lazy"/>
              </div> 
              <div className={`flex w-full mt-2 border btn-s ${turn ? '' : 'hidden'}`}>
                ...
                <button className={`menu_icon ${isOpen ? 'open' : ''}`} onClick={toggleMenu}>
                  <img src="/assets/bar.png" alt="bar icon" className="bar bar1" loading="lazy"/>
                  <img src="/assets/bar.png" alt="bar icon" className="bar bar2" loading="lazy"/>
                  <img src="/assets/bar.png" alt="bar icon" className="bar bar3" loading="lazy"/>
                  </button>
                  </div>
                </div> 
    </nav>
